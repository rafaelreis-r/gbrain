...
export const MIGRATIONS: Migration[] = [
  ...
  },
  {
    ...
    handler: async (engine) => {
      ...
      if (lang === 'english') {
        console.log(`  v120: trigger functions recreated with language='english' (default — no backfill needed)`);
        return;
      }
      ...
      console.log(`  v120: trigger functions recreated with language='${lang}' + backfilled existing rows`);
    },
  },
];
