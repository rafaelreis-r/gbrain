  ...
  (async () => {
    ...
    if (args.length === 0 || args.includes('--help') || args.includes('-h')) {
      console.log([
        ...
        '',
        'Usage:',
        '  bun scripts/gdoc-ingest.mjs <url> [--commit] [--via matrix-paste|drive-crawler|manual-cli]',
        ...
        '  bun scripts/gdoc-ingest.mjs --batch url1 url2 url3 --commit --via matrix-paste',
        '',
